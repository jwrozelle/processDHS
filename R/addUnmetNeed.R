#' Add Unmet Need Variables to Dataset
#'
...
#'
#' @param IRdata A dataframe containing individual recode (IR) file data from DHS. It must
...
#'
#' @return The function returns the input dataframe with additional columns related to unmet
...
#'
#' @details The function first checks if the `v626a` variable (representing unmet need according
